            ...
            Row(
              children : [
                Container(
                  ...
                  padding : const EdgeInsets.only(bottom : 10),
                  child : const Text('Transfer', style: TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.w800),
                )
                )
              ]
            ),
                    ...
                    children: [
                      Column(
                        children: [
                          Container(
                            ...
                            image: NetworkImage("https://picsum.photos/seed/picsum/200"), fit: BoxFit.fitWidth,
                              ),
                            ),
                          ),
                        ],
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          const Text("Madrid, Koeman Tepok Jidat", style: TextStyle( fontSize: 15, fontWeight: FontWeight.w800,
                                )),
                          ],
                        ),
                      ),
                ...
                children: [
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                          const Text("Barcelona Feb 13, 2021",style: TextStyle( fontSize: 15, fontWeight: FontWeight.w800,
                                )
                                ),
                          ],
                        ),
